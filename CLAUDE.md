...
Покрывает: Public API, Auth+Email (Resend, интерактивный ввод кода), Authenticated user (комменты, чат, поиск, presign), Staff API, Logout+отзыв токена, Yandex Object Storage (upload/download/public URL/delete).
